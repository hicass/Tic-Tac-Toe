/*----- constants -----*/
// A player Object to represent the 3 possible players (null, 1, -1) that also holds information
// about the corresponding colors, and corresponding symbol
const PLAYERS = {
...
// Each possible winning combination, based off the indexes of the "board divs".
const WIN_COMBOS = {
    topRow: [0, 1, 2],
    midRow: [3, 4, 5],
    botRow: [6, 7, 8],
